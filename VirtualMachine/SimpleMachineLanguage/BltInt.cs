...
/// <summary>
/// Implements the SML BltInt instruction.
/// Peeks integer value from the top of the
/// stack and checks if the integer specified as operand is less than the one from stack.
/// If it is lesser, then the jump on label specified in second operand is performed.
/// </summary>
